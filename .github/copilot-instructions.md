...
- 喰い替えとは、手牌ですでに完成している順子や刻子を同じ牌またはスジ牌を副露することによって崩したり組み替えたりする行為を指します
- 「喰い替え」が「無し」の場合、他家から副露したあとに、喰い替え行為に該当する打牌の選択を禁止します
- 例えば、345mの順子を持っていたときに、他家が捨てた赤5mをチーして、手牌の5mを捨てる行為も喰い替えに該当します（副露した牌が赤ドラであるかどうかは関係ない）
...
- 「責任払い」とは、通常、他家の大三元や大四喜、四槓子が確定しその役で和了りを許してしまった場合、その副露をしたプレイヤーに対して発生する罰則です
- 「責任払い」設定が「有り」の場合、特定の条件で責任払いが適用されます
- 「責任払い」設定が「無し」の場合、通常の支払い計算処理が適用されます

#### 大三元の責任払いの例

プレイヤーAが既に白と中を副露（ポンまたはカン）している状態で、プレイヤーBが發を捨て、プレイヤーAがそれを副露（ポンまたはカン）してプレイヤーAが大三元で和了った場合、プレイヤーBに責任払いが発生します。

#### 大四喜の責任払いの例

プレイヤーAが既に東と南と西を副露（ポンまたはカン）している状態で、プレイヤーBが北を捨て、プレイヤーAがそれを副露（ポンまたはカン）してプレイヤーAが大四喜で和了った場合、プレイヤーBに責任払いが発生します。

#### 四槓子の責任払いの例

プレイヤーAが既に3種の牌をカン（暗槓、明槓、加槓は問わない）している状態で、プレイヤーBが4種目の牌を捨て、プレイヤーAがそれをカンして四槓子で和了った場合、プレイヤーBに責任払いが発生します。

ただし、プレイヤーAが既に3種の牌をカンしている状態で、プレイヤーBが4種目の牌を捨て、プレイヤーAがそれをポンしたうえで、後続のターンで加槓した直後の嶺上牌で四槓子で和了った場合は、プレイヤーBに責任払いは発生しません。

#### 責任払いの支払い

- プレイヤーAがツモ和了した場合、その全額を責任払いのプレイヤーBが支払います
- プレイヤーAが（プレイヤーB以外から）ロン和了した場合、振り込んだプレイヤーとプレイヤーBが半額ずつ支払います
- プレイヤーAがプレイヤーBからロン和了した場合、責任払いは関係なくプレイヤーBが全額支払います
