...
describe("getTenpaiTiles", () => {
  ...
  it("単騎待ち: 111m222m333m444m 5m → 5m 待ち", () => {
    const closedTiles: TT[] = [
      ...
      TT.Man2, TT.Man2, TT.Man2,
      TT.Man3, TT.Man3, TT.Man3,
  ...
  it("テンパイでない場合は空配列", () => {
    const closedTiles: TT[] = [
      TT.Man1, TT.Man3, TT.Man5, TT.Man7, TT.Man9,
      TT.Sou1, TT.Sou3, TT.Sou5,
      TT.Pin2, TT.Pin4, TT.Pin6, TT.Pin8,
      TT.Ton,
    ];
    const waiting = getTenpaiTiles(closedTiles, []);
  ...
  it("同一牌が4枚使用済みだと待ち牌に含まれない", () => {
    ...
    const closedTiles: TT[] = [
      TT.Man1, TT.Man1, TT.Man1, TT.Man1,
      TT.Man2, TT.Man3,
      TT.Sou1, TT.Sou2, TT.Sou3,
      TT.Pin1, TT.Pin2, TT.Pin3,
      TT.Ton,
    ];
    const waiting = getTenpaiTiles(closedTiles, []);
...
describe("isKyuushuKyuuhai", () => {
  it("幺九牌が9種以上なら true", () => {
    const closedTiles: TT[] = [
      TT.Man1, TT.Man9, TT.Sou1, TT.Sou9, TT.Pin1, TT.Pin9,
      TT.Ton, TT.Nan, TT.Sha,
      TT.Man2, TT.Man3, TT.Man4, TT.Man5, TT.Man6,
    ];
  ...
  it("幺九牌が9種ちょうどなら true", () => {
    const closedTiles: TT[] = [
      TT.Man1, TT.Man9, TT.Sou1, TT.Sou9, TT.Pin1, TT.Pin9,
      TT.Ton, TT.Nan, TT.Sha,
      TT.Man2, TT.Man2, TT.Man3, TT.Man3, TT.Man4,
    ];
    expect(isKyuushuKyuuhai(closedTiles)).toBe(true);
  });
  ...
  it("幺九牌が8種以下なら false", () => {
    const closedTiles: TT[] = [
      TT.Man1, TT.Man9, TT.Sou1, TT.Sou9, TT.Pin1, TT.Pin9,
      TT.Ton, TT.Nan,
      TT.Man2, TT.Man3, TT.Man4, TT.Man5, TT.Man6, TT.Man7,
    ];
  ...
  it("中張牌だけでは false", () => {
    const closedTiles: TT[] = [
      TT.Man2, TT.Man3, TT.Man4, TT.Man5, TT.Man6, TT.Man7, TT.Man8,
      TT.Sou2, TT.Sou3, TT.Sou4, TT.Sou5, TT.Sou6, TT.Sou7, TT.Sou8,
    ];
    expect(isKyuushuKyuuhai(closedTiles)).toBe(false);
  });
});
